...
import fr.universecorp.launcher.ui.panels.pages.content.Settings;
...
public class PokeApp extends Panel {
    ...
    public void init(PanelManager panelManager) {
        ...
        ImageView imageText = new ImageView(new Image("/images/poketext.png"));
        setCenterH(imageText);
        imageText.setTranslateY(105d);
        ...
        Label title = new Label("PokeUniverse");
        ...
        homeBtn.setGraphic(new ImageView(new Image("/images/pokeball2.png")));
        ...
        ImageView map = new ImageView(new Image("/images/map.png"));
        map.setFitWidth(110);
        map.setFitHeight(110);
        mapBtn.setGraphic(map);
        mapBtn.setOnMouseClicked(e -> {
            HostServicesDelegate hostServices = HostServicesDelegate.getInstance(Launcher.getInstance());
            hostServices.showDocument("http://pokemap.universecorp.fr/");
        });
        sidemenu.getChildren().add(mapBtn);


        Label mapLabel = new Label("Dynmap");
        setCenterH(mapLabel);
        setCanTakeAllSize(mapLabel);
        mapLabel.setTranslateY(115d);
        mapLabel.setTranslateX(90d);
