...
public class PokeLogin extends Panel {
    ...
    public void init(PanelManager panelManager) {
        ...
        ImageView pokeball = new ImageView(new Image("/images/pokeball.png"));
        this.selecBtn.setGraphic(pokeball);
