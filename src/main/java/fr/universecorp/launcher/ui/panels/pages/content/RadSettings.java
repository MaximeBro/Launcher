...
import fr.universecorp.launcher.ui.panels.pages.RadApp;
...
public class RadSettings extends ContentPanel {
    ...
    public String getStylesheetPath() {
        return "css/content/radsettings.css";
    }
    ...
    public void init(PanelManager panelManager) {
        ...
        ImageView iconView = new ImageView(new Image("/images/rad-save2.png"));
        ...
        ImageView cancelIcon = new ImageView(new Image("/images/back3.png"));
        ...
        backBtn.setOnMouseClicked(e -> this.panelManager.showPanel(new RadApp()));
